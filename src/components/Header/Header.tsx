      ...
      <div className='mx-auto max-w-[1200px] px-4'>
        <div className='flex justify-end'>
          ...
          >
            ...
            <span className='px-1 text-sm'>Tiếng Việt</span>
            <svg
              xmlns='http://www.w3.org/2000/svg'
              fill='none'
              viewBox='0 0 24 24'
          ...
          {!isAuthenticated && (
            <div className='mx-4 flex  items-center gap-5'>
              <Link
                to='/register'
                className=' cursor-pointer border border-transparent border-r-slate-300/60 pr-4 text-sm'
              >
                Đăng ký
              </Link>
        ...
        <div className='mt-4 grid grid-cols-12 items-end gap-4'>
          <Link to='/' className='col-span-2'>
            <svg viewBox='0 0 192 65' className='h-12 cursor-pointer fill-white'>
              <g fillRule='evenodd'>
          ...
          <form className='col-span-9' onSubmit={onSubmit}>
            <div className='flex overflow-hidden rounded-sm bg-white p-1'>
              <input
                {...register('name')}
          ...
          <div className='col-span-1 justify-self-center'>
            <Popover
              renderPopover={
                <div className='max-w-[400px] rounded-sm bg-white shadow-md'>
                  {data?.data.data ? (
                    <div className='p-2'>
                      <div className='text-gray-900'>Sản Phẩm Mới Thêm</div>
                      <div className='mt-4'>
                        {data?.data.data.map((purchase) => {
                          return (
                            <div className='mt-2 flex' key={purchase._id}>
                              <div className='flex-shrink-0'>
                                <img src={purchase.product.image} alt='' className='h-10 w-10 object-cover' />
                              </div>
                              <div className='ml-2 flex-grow overflow-hidden'>
                                <div className='truncate text-sm'>{purchase.product.name}</div>
                              </div>
                              <div className='ml-2 text-sm text-orange'>{formatCurrency(purchase.product.price)}</div>
                            </div>
                          )
                        })}
                      </div>
